...
public class SrsEncoder {
    ...
    public static final String ACODEC = "audio/mp4a-latm";//MediaFormat.MIMETYPE_AUDIO_AAC;
    ...
    public static final int ASAMPLERATE = 22050;
    public static int aChannelConfig = AudioFormat.CHANNEL_IN_MONO;
    public static final int ABITRATE = 48 * 1000;  // 64 kbps
    ...
    public AudioRecord chooseAudioRecord() {
        AudioRecord mic = new AudioRecord(MediaRecorder.AudioSource.MIC, SrsEncoder.ASAMPLERATE,
            AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, getPcmBufferSize() * 4);
        if (mic.getState() != AudioRecord.STATE_INITIALIZED) {
            mic = new AudioRecord(MediaRecorder.AudioSource.MIC, SrsEncoder.ASAMPLERATE,
                AudioFormat.CHANNEL_IN_MONO, AudioFormat.ENCODING_PCM_16BIT, getPcmBufferSize() * 4);
            if (mic.getState() != AudioRecord.STATE_INITIALIZED) {
                mic = null;
            } else {
    ...
    private int getPcmBufferSize() {
        int pcmBufSize = AudioRecord.getMinBufferSize(ASAMPLERATE, AudioFormat.CHANNEL_IN_MONO,
